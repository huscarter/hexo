...
6. 缓存
   ...
   | 同步                  | 异步              | 方法描述         |
   | --------------------- | ----------------- | ---------------- |
   | my.setStorageSync     | my.setStorage     | 存储数据         |
   | my.getStorageSync     | my.getStorage     | 获取数据         |
   | my.clearStorageSync   | my.cleaeStorage   | 清除缓存数据     |
   | my.removeStorageSync  | my.removeStorage  | 删除某个缓存数据 |
   | my.getStorageInfoSync | my.getStorageInfo | 获取缓存数据信息 |
